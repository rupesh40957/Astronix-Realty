...
// Assuming iconsByCategory is defined elsewhere and available in this scope.  Example:
    ...
    <div className="p-6">
      ...
      <Form {...form}>
        ...
        >
          ...
          {/* New Card for Location & Similar Properties */}
          <Card>
            <CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="https://maps.google.com/..." disabled={isViewMode} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        <SelectContent>
                          {properties?.filter(p => p.id !== parseInt(id as string, 10)).map((property) => (
